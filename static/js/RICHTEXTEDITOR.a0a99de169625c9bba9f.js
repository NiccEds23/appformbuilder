...
function ReactFroala(props){var _window,_window$appformBuilde,_window2,_window2$appformBuild;var FroalaToolbarJson1=Properties_FroalaToolbarJson;if(window.selectFeatureToBeIncludedInRichText){FroalaToolbarJson1=window.selectFeatureToBeIncludedInRichText();}var toolbarOptions=[];function getFeatureForRichTextEditor(){Object.keys(FroalaToolbarJson1).forEach(function(key){if(FroalaToolbarJson1[key]==="true"||FroalaToolbarJson1[key]===true){toolbarOptions.push(key);}});return toolbarOptions;}var froalaEditorConfig={attribution:false,language:"".concat(((_window=window)===null||_window===void 0?void 0:(_window$appformBuilde=_window.deptiKUR_configs)===null||_window$appformBuilde===void 0?void 0:_window$appformBuilde.selectedLanguage)==="ar"||((_window2=window)===null||_window2===void 0?void 0:(_window2$appformBuild=_window2.deptiKUR_configs)===null||_window2$appformBuild===void 0?void 0:_window2$appformBuild.selectedLanguage)==="ar-SA"?"ar":null),placeholderText:"Your content goes here!",toolbarButtons:{moreText:{buttons:getFeatureForRichTextEditor(),id:props.id,buttonsVisible:25}},toolbarSticky:true,pluginsEnabled:["align","colors","entities","fontSize","fontFamily","link","lists","paragraphFormat","paragraphStyle","save","table","wordPaste","lineHeight","charCounter"],key:"YNB3fH3C9B10D6C5C2F3C-8TMIBDIa1NTMNZFFPFZc1d1Ib2a1E1fA4A3G3C3F2B6B3C4D3C1=="};var _useState=Object(react["useState"])(),_useState2=Object(slicedToArray["a" /* default */])(_useState,2),data=_useState2[0],setData=_useState2[1];var editorRef=Object(react["useRef"])(null);Object(react["useEffect"])(function(){if(props){if(editorRef.current){// Access the Froala Editor instance and set the id attribute
